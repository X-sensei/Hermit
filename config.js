...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || 'DIABLO☣️',
    ...
    BOT_INFO: process.env.BOT_INFO || 'DIABLO;RONEN;972528277755;https://i.imgur.com/6oRG106.jpeg',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'DIABLO;RONEN;https://i.imgur.com/fj2WE83.jpeg' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? 'DIABLO;RONEN' : process.env.STICKER_DATA,
    ...
    HEROKU: {
       ...
       SUDO: process.env.SUDO || '916000530073,0',
       DEBUG: DEBUG
};
